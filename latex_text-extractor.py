...
latex_text_summarizer = LatexTextParser(file_sample)
section_content_file, abstract_file, section_names_file = latex_text_summarizer.latex_text_parser()
...
latex_text_summarizer = LatexTextParser(file_sample2)
section_content_file2, abstract_file2, section_names_file2 = latex_text_summarizer.latex_text_parser()
